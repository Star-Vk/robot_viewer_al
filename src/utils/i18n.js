...
export const translations = {
    'zh-CN': {
        ...
        // 动作库
        'importActions': '导入 CSV',
        'play': '播放',
        'pause': '暂停',
        'stop': '停止',
        'speed': '倍速',
        'timeline': '时间轴',
        'noActionsLoaded': '未加载动作',
        'actionSelectPrompt': '请选择或导入一个动作',
        'actionFrames': '帧数',
        'actionDuration': '时长',
        'actionJoints': '关节',
        'actionMapped': '可播放关节',
        'actionUnmapped': '未映射行',
        'actionMissingModelJoints': '模型缺失关节',
        'actionModelRequired': '请先加载机器人模型',
        'actionImported': '已导入动作',
        'actionNoMappedRows': '没有可映射的动作行',
        'actionNoCsvFiles': '未选择 CSV 文件',
        'actionPlaybackFinished': '动作播放完成',
        'actionPlaybackCancelled': '已取消动作播放',
        'mapping': '映射',
        'mappingName': '映射名',
        'mappingEntries': '映射条目',
        'mappingSource': '来源',
        'mappingLoading': '正在加载映射',
        'mappingImport': '导入映射',
        'mappingReset': '恢复默认',
        'mappingLoaded': '已加载映射',
        'mappingLoadedFromStorage': '已加载上次使用的映射',
        'mappingLoadFailed': '映射加载失败',
        'mappingResetToDefault': '已恢复默认映射',
        'mappingSourceDefault': '默认文件',
        'mappingSourceCustom': '自定义文件',
        'mappingSourceFallback': '内置回退',
        'mappingDefaultPlaybackConfirm': '当前未导入自定义映射规则，将使用默认映射播放动作库。确认继续吗？',
    ...
    'en-US': {
        ...
        // Action library
        'importActions': 'Import CSV',
        'play': 'Play',
        'pause': 'Pause',
        'stop': 'Stop',
        'speed': 'Speed',
        'timeline': 'Timeline',
        'noActionsLoaded': 'No actions loaded',
        'actionSelectPrompt': 'Select or import an action',
        'actionFrames': 'Frames',
        'actionDuration': 'Duration',
        'actionJoints': 'Joints',
        'actionMapped': 'Playable Joints',
        'actionUnmapped': 'Unmapped Rows',
        'actionMissingModelJoints': 'Missing Model Joints',
        'actionModelRequired': 'Load a robot model first',
        'actionImported': 'Imported actions',
        'actionNoMappedRows': 'No playable rows found in CSV',
        'actionNoCsvFiles': 'No CSV files selected',
        'actionPlaybackFinished': 'Playback finished',
        'actionPlaybackCancelled': 'Playback cancelled',
        'mapping': 'Mapping',
        'mappingName': 'Mapping',
        ...
        'mappingReset': 'Reset Default',
        'mappingLoaded': 'Mapping loaded',
        'mappingLoadedFromStorage': 'Loaded previously used mapping',
        'mappingLoadFailed': 'Failed to load mapping',
        'mappingResetToDefault': 'Reset to default mapping',
        'mappingSourceDefault': 'Default file',
        'mappingSourceCustom': 'Custom file',
        'mappingSourceFallback': 'Built-in fallback',
        'mappingDefaultPlaybackConfirm': 'No custom mapping has been imported. Continue playback with the default mapping?',
